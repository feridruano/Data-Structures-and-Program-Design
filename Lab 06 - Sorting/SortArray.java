...
public class SortArray
{
    ...
    void improvedBubbleSort( T[] a )
    {
        ...
        startStatistics(); // Reset comparisons and moves

        // Divides array into unsorted and sorted
        while ( swap && leftIndex < rightIndex )
        {
            swap = false; // Control flag
            ...
            for ( int index = leftIndex; index < rightIndex; index++ )
            {
                ...
                {
                    swap( a, index, index + 1 );
                    swap = true; // At least one swap sets the control flag to true, else false
                }
            }
            rightIndex--; // Increase sorted portion of array
        }
    ...
    void shakerImprovedBubbleSort( T[] a )
    {
        ...
        while ( swap && leftIndex < rightIndex )
        {
            ...
            rightIndex--; // Increase sorted portion of array on right half

            // Iterate and compare right to left
            ...
            leftIndex++; // Increase sorted portion of array on left half
        }
        //TODO Project1 F - Done
    }
    ...
    private static void reverseOrder( Integer[] data )
    {
        ...
        // Swap the left half with right half of array
    ...
    private static Integer[] generateRandomArray( int size )
    {
        ...
        // Constant max value set to 99
        final int MAX_VALUE = 99;

        // Create a random object
        Random numGen = new Random( 101 );

        // Add random entries to result[]
        for ( int index = 0; index < result.length; index++ )
            result[index] = numGen.nextInt( MAX_VALUE + 1 );
