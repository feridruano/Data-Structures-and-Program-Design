...
public class MinAndSumInArray
{
    ...
    public static int minimum( int[] data, int first, int last )
    {
        ...
        if ( data == null || data.length < 1 || first < 0 || last < first || first > data.length - 1 )
            throw new BadArgumentsForMinimumException( "INVALID" );
        // STEP #2 base case: first and last are the same
        if ( first == last )
            return data[first];
        int mid = first + ( last - first ) / 2;
        // recursively find minimum in each half
        if ( minimum( data, first, mid ) > minimum( data, mid + 1, last ) )
            result = minimum( data, mid + 1, last ); // set result to the smallest of the two
        else
            result = minimum( data, first, mid ); // Recursively call if less than
        return result;
    } // end minimum
    ...
    public static int sumArrayStartWithFirst( int[] array, int first, int last )
    {
        ...
        if ( first == last )
            ...
            // Recursively sum up elements from first to last
    ...
    public static int sumArrayStartWithLast( int[] array, int first, int last )
    {
        ...
        if ( first == last )
            ...
            // Recursively sum up elements from last to first
    ...
    public static int sumArraySplitInTwo( int[] array, int first, int last )
    {
        ...
        else
        {
            // Calculate mid
            int mid = first + ( last - first ) / 2;
            // Recursively sum up elements in both halves
    ...
    public static int sumArraySplitInTwoAddMid( int[] array, int first, int last )
    {
        ...
        else
        {
            // Calculate mid
            int mid = first + ( last - first ) / 2;
            // Check if mid is first
            if ( mid == first )
                // Sum up mid elements up to last
                return array[mid] + sumArraySplitInTwoAddMid( array, mid + 1, last );
            // Mid is not first, recursively sum up elements from two halves and mid element
            return sumArraySplitInTwoAddMid( array, first, mid - 1 ) + array[mid] +
                   sumArraySplitInTwoAddMid( array, mid + 1, last );
        }
    ...
    public void testGoodValues()
    {
        ...
        if ( smallest == 4 )
            ...
            System.out.println(
                    "*** Failed test: returned smallest value of " + smallest + " is not expected value of 4" );
        ...
        if ( smallest == 2 )
            ...
            System.out.println(
                    "*** Failed test: returned smallest value of " + smallest + " is not expected value of 2" );
        ...
        if ( smallest == 3 )
            ...
            System.out.println(
                    "*** Failed test: returned smallest value of " + smallest + " is not expected value of 3" );
        ...
        if ( smallest == 10 )
            ...
            System.out.println(
                    "*** Failed test: returned smallest value of " + smallest + " is not expected value of 10" );
        ...
        if ( smallest == 13 )
            ...
            System.out.println(
                    "*** Failed test: returned smallest value of " + smallest + " is not expected value of 13" );
        ...
        if ( smallest == 9 )
            ...
            System.out.println(
                    "*** Failed test: returned smallest value of " + smallest + " is not expected value of 9" );
